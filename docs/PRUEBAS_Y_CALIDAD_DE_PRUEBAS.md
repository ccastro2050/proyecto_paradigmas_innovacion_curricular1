...
`api_innovacion/pruebas/prueba_capas.py`:
...
| **Prueba de capas** | `api_innovacion/pruebas/` | Que las reglas funcionen **y** que las capas estén cortadas |
...
10. En este repositorio: los criterios de `2_spec.md`, el smoke de
    `7_quickstart.md` y la prueba de capas de `api_innovacion/pruebas/` — la
