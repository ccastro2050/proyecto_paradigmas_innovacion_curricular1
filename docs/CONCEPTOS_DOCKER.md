...
flowchart LR
    ...
    subgraph PC["Su PC — Docker Desktop (el 'centro de datos')"]
        subgraph RED["red interna del compose (LAN virtual, con DNS propio)"]
            APIFACTURAS["SERVIDOR DE APLICACIONES<br/>contenedor api-registros<br/>hostname: api-registros · escucha en 8030"]
    ...
    NAV -->|"localhost:8030"| APIFACTURAS
    ...
    NAV -.->|"opcional (diagnóstico):<br/>localhost:15451"| POSTGRES
